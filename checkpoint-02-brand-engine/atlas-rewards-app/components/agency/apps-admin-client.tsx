...
import {
  Plus, Search, Radar, Folder, FolderPlus, Pencil, ArrowLeft,
      ...
      <header className="relative px-8 pt-10 pb-6 overflow-hidden">
        ...
        <div className="relative flex items-start justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 shrink-0">
            {/* CP-111: the old Pipeline board became Founder Headquarters. */}
            <Link href="/agency/headquarters">
              <Button variant="outline" className="border-sky-400/30 bg-white/5 text-white hover:bg-white/10">
                <Radar className="h-4 w-4 mr-1.5" /> Headquarters
              </Button>
            </Link>
