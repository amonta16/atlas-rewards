...
import { CalendarClock, Check, Loader2, Plus, Users, Phone, X, UserX, Settings2, Trash2, Power, ChevronDown, ChevronUp } from "lucide-react";
...
function ResourceSetup({
  business, resources, enabled, onToggleEnabled, onChanged,
}: { business: Business; resources: BookingResource[]; enabled: boolean; onToggleEnabled: () => void; onChanged: () => void }) {
  const primary = business.brand_colors.primary;
