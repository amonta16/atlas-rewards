      ...
      >
        <div className="px-5 h-20 flex items-center gap-3 border-b border-white/15">
          <div className="h-10 w-10 rounded-xl bg-white flex items-center justify-center overflow-hidden shrink-0 shadow">
            {business.logo_url ? (
              ...
              <span className="text-sm font-black" style={{ color: business.brand_colors.primary }}>{business.name[0]}</span>
            )}
          </div>
        ...
        {actions.total > 0 && (
          ...
          >
            ...
            <div className="text-[11px] text-zinc-700 mt-1 leading-snug">
              {[
        ...
        <div className="border-t border-white/15 px-3 py-3 space-y-0.5">
          ...
          {bizSavedAt && (
            <span className="px-3 text-[11px] text-emerald-200 flex items-center gap-1"><Check className="h-3 w-3"/> Saved</span>
          )}
        </div>
      </aside>
