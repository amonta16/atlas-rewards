          ...
          {STEPS.map((s, i) => (
            <Reveal as="li" key={s.n} delay={i * 90} className="lp-card group relative flex flex-col p-6">
              <div className="flex items-center justify-between">
                ...
                <span className="grid h-9 w-9 place-items-center rounded-lg border border-[#e8dfd1] bg-white text-slate-800 transition-colors group-hover:border-[#1f5f8b]/40 group-hover:text-[#1f5f8b]">
