    ...
    <section id={ANCHORS.pricing} className="relative scroll-mt-24 py-20 md:py-28" aria-labelledby="pricing-title">
      <div className="lp-container">
        ...
        <div ref={ref} className="mx-auto mt-12 grid max-w-4xl gap-5 lg:grid-cols-[1.15fr_0.85fr]">
          ...
          <Reveal delay={100} className="relative overflow-hidden rounded-2xl border border-amber-300/60 bg-gradient-to-b from-amber-50 to-transparent p-6 sm:p-8">
            ...
            <ul className="mt-5 space-y-2 text-sm text-slate-700">
              <li className="flex gap-2"><Check className="mt-0.5 h-4 w-4 text-amber-700" aria-hidden /> <span>Founding rate, locked for the life of the account <span className="lp-placeholder whitespace-nowrap rounded px-1 font-mono text-[10px]">[ CONFIRM ]</span></span></li>
              <li className="flex gap-2"><Check className="mt-0.5 h-4 w-4 text-amber-700" aria-hidden /> Hands-on setup with the Atlas team</li>
              <li className="flex gap-2"><Check className="mt-0.5 h-4 w-4 text-amber-700" aria-hidden /> Input on what we build next</li>
            </ul>
