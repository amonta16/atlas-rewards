...
const WEDGES = [
  ...
  { label: "2× points", c1: "#f0a35e", c2: "#e07a3f" },
  ...
  const spin = async () => {
    ...
    if (!reduce) {
      try {
        ...
        confetti({ particleCount: 70, spread: 60, startVelocity: 28, origin: { y: 0.7 }, colors: ["#1f5f8b", "#2a8fb5", "#e07a3f", "#f0a35e"], disableForReducedMotion: true });
      } catch {}
    }
  };
    ...
    <div className={cn("relative flex flex-col items-center", className)}>
      <div className="relative h-[260px] w-[260px] sm:h-[300px] sm:w-[300px]">
        ...
        <div className="absolute left-1/2 top-[-6px] z-20 -translate-x-1/2" aria-hidden>
          <div className="h-0 w-0 border-x-[11px] border-t-[22px] border-x-transparent border-t-[#e07a3f] drop-shadow-[0_4px_10px_rgba(20,33,61,0.35)]" />
        </div>
        {/* Ring glow */}
        <div className="absolute inset-0 rounded-full bg-[radial-gradient(closest-side,rgba(224,122,63,0.25),transparent)] blur-xl" aria-hidden />
        <svg
          viewBox="0 0 200 200"
