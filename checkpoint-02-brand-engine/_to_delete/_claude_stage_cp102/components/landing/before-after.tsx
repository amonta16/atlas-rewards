    ...
    <section className="relative py-20 md:py-28" aria-labelledby="ba-title">
      <div className="lp-container">
        ...
        <div className="relative mt-12 grid gap-4 lg:grid-cols-2">
          <Reveal className="lp-light rounded-2xl border border-[#e8dfd1] bg-white p-6 sm:p-8">
          ...
          <Reveal delay={120} className="lp-light relative overflow-hidden rounded-2xl border border-[#7dd3fc] bg-gradient-to-b from-[#e6f6fc] to-white p-6 sm:p-8 shadow-[0_20px_60px_-30px_rgba(31,95,139,0.35)]">
