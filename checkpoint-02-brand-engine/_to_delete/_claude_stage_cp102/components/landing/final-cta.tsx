...
export function FinalCTA() {
  return (
    <section className="relative overflow-hidden py-24 md:py-36" aria-labelledby="final-title">
      ...
      <div className="pointer-events-none absolute inset-0 bg-[url('/landing/team-field-blur.jpg')] bg-cover bg-center opacity-50" aria-hidden />
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[#0a3d62] via-[#0a3d62]/60 to-[#0a3d62]" aria-hidden />
