  ...
  return (
    <div ref={ref} className="mt-5">
      <div className="flex items-center gap-4">
        <div className={cn("relative grid h-16 w-16 place-items-center rounded-2xl bg-gradient-to-br from-[#38bdf8] to-[#1f5f8b] text-white shadow-[0_10px_30px_-10px_rgba(56,189,248,0.7)]", celebrate && "lp-pulse-once")}>
          ...
          return (
            <div
              ...
              className={cn(
                ...
                done ? "border-[#7dd3fc] bg-[#dff3fb] text-[#0e7490]" : "border-[#e8dfd1] bg-white text-slate-400",
                milestone && done && "lp-pop border-[#7dd3fc] bg-[#dff3fb] text-[#0e7490]",
              )}
...
function ProgressDemo() {
  ...
  return (
    <div ref={ref} className="mt-5">
      ...
      <div className="lp-light mt-3 h-3 overflow-hidden rounded-full bg-white">
        <div
