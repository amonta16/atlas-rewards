      ...
      <div className="lp-container grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
        <Reveal>
          <p className="lp-eyebrow">
            <MapPin className="h-3.5 w-3.5 text-[#38bdf8]" aria-hidden /> Built on the Central Coast
          </p>
          ...
          <ul className="mt-7 grid gap-3 sm:grid-cols-3">
            {[
              ...
              <li key={t} className="lp-light rounded-xl border border-[#e8dfd1] bg-white p-4">
        ...
        <Reveal delay={120} className="relative">
          <div className="pointer-events-none absolute -left-8 -top-8 h-40 w-40 rounded-full bg-[radial-gradient(closest-side,rgba(125,211,252,0.35),transparent)] blur-2xl" aria-hidden />
          <div className="grid grid-cols-[1.3fr_1fr] gap-3 sm:gap-4">
            ...
            <div className="grid gap-3 sm:gap-4">
              ...
              <div className="lp-light rounded-2xl border border-[#e8dfd1] bg-white p-4">
