# Atlas — Fresh-project SQL runbook (CP-03 → CP-32)
...
|36 | `checkpoint-32-atlas-impact-and-notifications/cp32_migration.sql`   | Atlas Impact RPCs, review hotfix, notifications + push subscriptions |
...
# CP-32 — PWA push notifications (optional; in-app bell works without these)
