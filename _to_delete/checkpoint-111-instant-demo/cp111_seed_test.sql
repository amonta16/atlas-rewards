-- =====================================================================
-- Atlas · CP-111 create_demo_business seed test
-- =====================================================================
...
-- Assumes cp111_instant_demo.sql is applied. 'postgres' resets the role
...
begin
  ...
  raise notice '✅ CP-111 DEMO SEED OK — slug=%', v_slug;
end;
$t$;
rollback;
